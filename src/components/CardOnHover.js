...
const CardOnHover = ({course,index}) => {
    ...
    return (
        <div className={`z-10 hidden absolute  border border-amber-400 bg-gray-50  group-hover:block ${((index) % 5 ) === 3 || ((index) % 5 ) === 4 ? "2xl:ml-[-300px]" : "2xl:ml-[300px]"}  2xl:mt-[-350px]   w-[455px]  h-auto   overflow-x-hidden xl:m-10 2xl:m-6 cursor-pointer shadow-2xl rounded-lg hover:border-amber-600 box-border `}>
