 ...
 console.log(isPersonal);
   ...
   return <div className="border h-[450px] bg-black flex ml-[-45px] ">
         ...
         <div className=" mt-11 w-96 h-[720px] border border-amber-500  ">
            ...
            <p className="font-stretch-expanded font-serif font-bold text-3xl text-cyan-200 m-4 p-2 flex mt-7">
            ...
            <div className="border h-20  text-white flex">
              ...
              <div onClick={() => {setIsPersonal(false)}} className={`cursor-pointer w-1/2 h-20 ${!isPersonal ? "bg-amber-500 text-black" : "text-white"} text-white text-center pt-5 text-shadow-black text-3xl font-stretch-125%`}>Teams</div>
            </div>
           
            {isPersonal ? <Personal courseData = {courseData}/> : <Teams/>}
